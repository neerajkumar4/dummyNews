...
import news32 from "../images/news3.2.png"
import { Grid } from "@mui/material";
const Page3 = () => {
    return (
        <div className="news container-fluid">
            <h1 className="newsHead">Microstrategy Buys More Bitcoin — Company's Crypto Holdings Grow to 132,500 BTC</h1>
            <Grid container>
                <Grid item xs={12} sm={12} md={8}>
                    <img className="newsIMG" src={news3} alt="pic" />
                </Grid>
            ...
            <h3>Microstrategy Acquires More Bitcoin</h3>
            <h4>
            ...
            <p className="tweet">Microstrategy has increased its bitcoin holdings by ~2,500 BTC. As of 12/27/22 Microstrategy holds ~132,500 bitcoin acquired for ~$4.03 billion at an average price of ~$30,397 per bitcoin.
            </p>
            <p>In its filing with the U.S. Securities and Exchange Commission (SEC), Microstrategy clarified that the 2,500 coins were acquired between Nov. 1 and Dec. 24 by its wholly owned subsidiary Macrostrategy.
            ...
            <h4>Saylor said in an interview last week:</h4>
            <p className="tweet">
            ...
            <img className="newsIMG" src={news32} alt="pic" />
            <p>
